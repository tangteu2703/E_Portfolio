...
{
    public class DeviceManagementService :ServiceBase<DeviceManagement>, IDeviceManagementService
    {
        public DeviceManagementService(IRepositoryWrapper RepositoryWrapper) : base(RepositoryWrapper)
        {
