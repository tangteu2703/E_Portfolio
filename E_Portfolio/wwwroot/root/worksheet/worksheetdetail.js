    ...
    apiHelper.get(`/User/SelectAll`,
        ...
        <div class="d-flex align-items-center flex-grow-1">
            <div class="symbol symbol-30px symbol-circle">
                <img src="https://picsum.photos/200/300" alt="${user.Username}" />
            </div>
            <div class="ms-3">
                <div class="fw-bold text-gray-900 small">${user.Username}</div>
                <div class="text-muted small">${user.Usercode}</div>
            </div>
        </div>
        <div class="text-muted small ms-auto text-end" style="min-width: 100px;">
            ${user.DepartmentName}
        </div>
    `;
